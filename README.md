...
Приложение "Watch" позволяет получить данные: страну, город, время, дату и др.дополнительную информацию по местоположению пользователя. Рандомно выводится цитата. Выполнена адаптивная вёрстка (320px - 1440px). Использовано публичное API. Собственный дизайн приложения.
